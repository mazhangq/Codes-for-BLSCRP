%    This code is for the  Fig.6(a) and Fig.7(a) in the paper 
%    Author:   Qian Zhang and Lihua Yang
%    Date:      1 July 2020
%    Version:  2020.7.01

%    varing the size of graph, from N=20000 to N=80000
%    fixed n=1000, l=200

close all;
clear all;

Gsize=[20000:10000:80000];
iNum=length(Gsize); 
...
saveas(gcf, 'CompareLargeGraph_N1.jpg');
%%%%%%%%%%%%  Fig.2
...
saveas(gcf, 'CompareLargeGraph_N2.jpg');

%save('data_CompareLargeGraph_N')
