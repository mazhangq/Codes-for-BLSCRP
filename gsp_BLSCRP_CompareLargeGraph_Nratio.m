%    This code is for the  Fig.7(c) in the paper 
...
%%saveas(gcf, 'CompareLargeGraph_Nratio1.jpg');
%%%%%%%%%%%%  Fig.2
...
saveas(gcf, 'CompareLargeGraph_Nratio.jpg');

% save('data_CompareLargeGraph_Nratio')
